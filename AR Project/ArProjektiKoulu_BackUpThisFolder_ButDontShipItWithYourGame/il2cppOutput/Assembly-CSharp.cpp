...
struct SpawnableManager_tC029DDD2FD6DB3F1396C3546F6F6A7F53A395730  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	...
	// UnityEngine.GameObject SpawnableManager::EndGamePrefab
	GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* ___EndGamePrefab_7;
	// UnityEngine.GameObject SpawnableManager::DeleteText
	GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* ___DeleteText_8;
	...
	// System.Int32 SpawnableManager::spawnableCount
	int32_t ___spawnableCount_11;
};
...
IL_0008:
	{
		...
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_1 = __this->___arCam_9;
	...
	{
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_13 = __this->___spawnedObject_10;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_14;
	...
	}
	{
		...
		__this->___spawnedObject_10 = L_22;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___spawnedObject_10), (void*)L_22);
		...
		NullCheck(L_25);
		Material_set_color_m5C32DEBB215FF9EE35E7B575297D8C2F29CC2A2D(L_25, L_29, NULL);
		goto IL_0140;
	}
...
IL_00d7:
	{
		...
		List_1_t0754071572EFE7A5C92A59495D2524FC935364E3* L_30 = __this->___m_Hits_5;
		NullCheck(L_30);
		...
		L_32 = ARRaycastHit_get_pose_m84C13E71E21FE12CBA9AAD98DC28B1E414C9EFFD((&V_3), NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_33 = L_32.___position_0;
		SpawnableManager_SpawnPrefab_mF522EF88B8AAB43C88ADC75967DDEE81030F05DB(__this, L_33, NULL);
		goto IL_0140;
	}
...
IL_00f8:
	...
	{
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_36 = __this->___spawnedObject_10;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_37;
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_38 = __this->___spawnedObject_10;
		NullCheck(L_38);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_39;
		L_39 = GameObject_get_transform_m0BC10ADFA1632166AE5544BDF9038A2650C2AE56(L_38, NULL);
		List_1_t0754071572EFE7A5C92A59495D2524FC935364E3* L_40 = __this->___m_Hits_5;
		NullCheck(L_40);
		ARRaycastHit_tB32B5606815B8A7DF479C00187A852F8D20E3B70 L_41;
		L_41 = List_1_get_Item_m443F0D48247776D4257E06597AF794BCF6D8020F(L_40, 0, List_1_get_Item_m443F0D48247776D4257E06597AF794BCF6D8020F_RuntimeMethod_var);
		V_3 = L_41;
		Pose_t06BA69EAA6E9FAF60056D519A87D25F54AFE7971 L_42;
		L_42 = ARRaycastHit_get_pose_m84C13E71E21FE12CBA9AAD98DC28B1E414C9EFFD((&V_3), NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SpawnableManager_SpawnPrefab_mF522EF88B8AAB43C88ADC75967DDEE81030F05DB (SpawnableManager_tC029DDD2FD6DB3F1396C3546F6F6A7F53A395730* __this, Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 ___0_spawnPosition, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->___spawnedObject_10 = L_3;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___spawnedObject_10), (void*)L_3);
		// spawnableCount++;
		int32_t L_4 = __this->___spawnableCount_11;
		__this->___spawnableCount_11 = ((int32_t)il2cpp_codegen_add(L_4, 1));
		// if (spawnableCount == 5)
		int32_t L_5 = __this->___spawnableCount_11;
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_6 = __this->___EndGamePrefab_7;
		...
		// Destroy(DeleteText);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_10 = __this->___DeleteText_8;
