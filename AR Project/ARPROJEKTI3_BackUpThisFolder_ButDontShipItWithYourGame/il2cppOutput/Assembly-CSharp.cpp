...
struct SpawnableManager_tC029DDD2FD6DB3F1396C3546F6F6A7F53A395730  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	...
	// UnityEngine.Color[] SpawnableManager::availableColors
	ColorU5BU5D_t612261CF293F6FFC3D80AB52259FF0DC2B2CC389* ___availableColors_7;
...
IL_00c9:
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_31 = __this->___spawnedObject_9;
		NullCheck(L_31);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SpawnableManager_SpawnPrefab_mF522EF88B8AAB43C88ADC75967DDEE81030F05DB (SpawnableManager_tC029DDD2FD6DB3F1396C3546F6F6A7F53A395730* __this, Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 ___0_spawnPosition, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->___spawnedObject_9 = L_3;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___spawnedObject_9), (void*)L_3);
		// }
		return;
	}
}
// System.Void SpawnableManager::OnPointerClick(UnityEngine.EventSystems.PointerEventData)
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SpawnableManager_OnPointerClick_m48C1189F09B602D1BEE4A723CB2D057AEAD7E367 (SpawnableManager_tC029DDD2FD6DB3F1396C3546F6F6A7F53A395730* __this, PointerEventData_t9670F3C7D823CCB738A1604C72A1EB90292396FB* ___0_eventData, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
	...
	{
		// if (spawnedObject != null && spawnedObject.CompareTag("Spawnable"))
	...
	{
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_2 = __this->___spawnedObject_9;
		NullCheck(L_2);
		bool L_3;
		L_3 = GameObject_CompareTag_m6378BE50D009A93D46036F74CC3F7E2ECB0636E5(L_2, _stringLiteral987703431C77C5E98624964EF0E5B726F46C7E4F, NULL);
		if (!L_3)
		{
			goto IL_004e;
		}
	...
	{
		// spawnedObject.GetComponent<Renderer>().material.color = availableColors[Random.Range(0, availableColors.Length)];
		...
		ColorU5BU5D_t612261CF293F6FFC3D80AB52259FF0DC2B2CC389* L_7 = __this->___availableColors_7;
		ColorU5BU5D_t612261CF293F6FFC3D80AB52259FF0DC2B2CC389* L_8 = __this->___availableColors_7;
		NullCheck(L_8);
		int32_t L_9;
